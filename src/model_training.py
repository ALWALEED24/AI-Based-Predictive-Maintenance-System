...
# ---------------------------------------------------------
def train_isolation_forest(scaled_data, X_train=None, y_train=None, X_test=None, y_test=None):
    """
    ...
    - For evaluation, the model is trained using normal training records only.
      This makes the model learn the normal operating pattern.
    ...
    # decision_function: higher score = more normal, so multiply by -1 for failure-risk score
    ...
    # Final predictions for the full dashboard output
...
# ---------------------------------------------------------
def train_one_class_svm(scaled_data, X_train=None, y_train=None, X_test=None, y_test=None):
    """
...
# ---------------------------------------------------------
def train_random_forest(scaled_data, X_train=None, y_train=None, X_test=None, y_test=None):
    """
...
def run_all_models(scaled_data):
    ...
    print(evaluation_results[["model", "accuracy", "precision", "recall", "f1_score", "pr_auc"]])
    ...
    return {
        ...
        # Backward-compatible key from previous code
        ...
        # Final full dataset output for the dashboard/pipeline
