...
def evaluate_all_models(final_results, rf_metrics):
    ...
    if "if_anomaly_label" in final_results.columns:
        ...
        elif "if_risk_score" in final_results.columns:
            if_score = final_results["if_risk_score"]
        else:
            if_score = y_pred_if
    ...
    if "ocsvm_anomaly_label" in final_results.columns:
        ...
        elif "ocsvm_risk_score" in final_results.columns:
            ocsvm_score = final_results["ocsvm_risk_score"]
        else:
